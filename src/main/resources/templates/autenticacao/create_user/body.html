...
<table class="table gradient">
    ...
    <tr>
        ...
        <td class="body body-head">
            ...
            <p>Seja bem-vindo ao PECS,Estamos muito felizes em tê-lo conosco,<br> abaixo se encontra sua senha de acesso</p>
        </td>
        <td></td>
    </tr>
    <tr>
        ...
        <td class="body">
            <div class="body-content">
                <p class="text">A sua <strong class="text-decoration">senha</strong> é:</p>
                <div class="content-center">
                    <p class="token">${senha}</p>
                </div>
                <p class="text">
                    Lembre-se: por segurança,
                    <span class="text-decoration">não compartilhe</span> sua senha com outras pessoas!
                </p>
            </div>

            <div class="body-foot">
                <p class="atenciosamente">Antenciosamente,</p>
                <p class="text2 text-decoration">Equipe PECS.</p>
            </div>
        </td>
